    ...
    update: function() {
     ...
     // myGame.player.x = this.input.x - myGame.player.width/2;
      ...
      this.physics.arcade.overlap(myGame.player, myGame.meatGroup, eatMeat);
        this.physics.arcade.overlap(myGame.recycle, myGame.meatGroup, eatMeat);
        this.physics.arcade.overlap(myGame.trash, myGame.meatGroup, eatMeat);
...
var spawnMeat = function(game) {
  ...
  meat.inputEnabled = true;
  meat.input.enableDrag();
